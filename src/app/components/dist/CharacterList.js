...
function CharacterList() {
    ...
    return (react_1["default"].createElement(framer_motion_1.motion.div, { className: "text-white container" },
        ...
        react_1["default"].createElement(framer_motion_1.motion.div, { initial: "hidden", animate: "visible", variants: staggerVariants },
            react_1["default"].createElement("ul", { className: "flex items-center justify-center flex-wrap gap-3 mt-[4rem]" }, sortedCharacters.map(function (character, index) { return (react_1["default"].createElement(link_1["default"], { key: index, href: "/characters/[character]", as: "/characters/" + character.name.toLowerCase() },
                react_1["default"].createElement(framer_motion_1.motion.li, { variants: staggerVariants, className: "flex-20 flex-col justify-center items-center max-w-[10rem] border-[3px] border-solid border-white rounded-md hover:border-blue-500 hover:opacity-[0.5] transition-all duration-300" },
